...
function StatItem({ count, label, onPress }: any) {
  return (
    <Pressable onPress={onPress} disabled={!onPress} style={[styles.statItem, { backgroundColor: 'transparent' }]}>
...
const styles = StyleSheet.create({
  ...
  userText: { flex: 1, marginLeft: 15 },
  userName: { fontSize: 22, fontWeight: 'bold' },
  headline: { fontSize: 13, marginTop: 4 },
  statsGrid: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10 },
  statItem: { alignItems: 'center', flex: 1 },
  statNum: { fontSize: 18, fontWeight: 'bold' },
  statLabel: { fontSize: 12, marginTop: 4 },
  menuSection: { paddingHorizontal: 16, borderRadius: 16, marginHorizontal: 12, overflow: 'hidden' },
  menuItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 15 },
  menuLeft: { flexDirection: 'row', alignItems: 'center' },
  iconBox: { width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
  menuTitle: { fontSize: 16, marginLeft: 12, fontWeight: '500' },
  logoutBtn: { marginTop: 30, paddingVertical: 15, alignItems: 'center' },
  logoutText: { color: '#ff4d4f', fontSize: 16, fontWeight: '600' },
  badgeContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'transparent' },
  badgeText: { backgroundColor: '#ff4d4f', color: '#fff', fontSize: 12, fontWeight: 'bold', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 10, overflow: 'hidden', marginRight: 4 },
});
